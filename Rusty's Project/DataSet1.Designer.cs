...
namespace Rusty_s_Project {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(int Id, string Full_Name, string Position, string Department, string Supervisor, decimal Salary) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public string Supervisor {
                get {
                    return ((string)(this[this.tableEmployees.SupervisorColumn]));
                }
                set {
...
namespace Rusty_s_Project.DataSet1TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([Id] = @Original_Id) AND ([Full Name] = @Or" +
                "iginal_Full_Name) AND ([Position] = @Original_Position) AND ([Department] = @Ori" +
                "ginal_Department) AND ([Supervisor] = @Original_Supervisor) AND ([Salary] = @Ori" +
                "ginal_Salary))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([Id], [Full Name], [Position], [Department], [Supervisor], [Salary]) VALUES (@Id, @Full_Name, @Position, @Department, @Supervisor, @Salary);
SELECT Id, [Full Name], Position, Department, Supervisor, Salary FROM Employees WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [Id] = @Id, [Full Name] = @Full_Name, [Position] = @Position, [Department] = @Department, [Supervisor] = @Supervisor, [Salary] = @Salary WHERE (([Id] = @Original_Id) AND ([Full Name] = @Original_Full_Name) AND ([Position] = @Original_Position) AND ([Department] = @Original_Department) AND ([Supervisor] = @Original_Supervisor) AND ([Salary] = @Original_Salary));
SELECT Id, [Full Name], Position, Department, Supervisor, Salary FROM Employees WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Rusty_s_Project.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [Full Name], Position, Department, Supervisor, Salary FROM dbo.Employe" +
                "es";
        ...
        public virtual int Delete(int Original_Id, string Original_Full_Name, string Original_Position, string Original_Department, string Original_Supervisor, decimal Original_Salary) {
        ...
        public virtual int Insert(int Id, string Full_Name, string Position, string Department, string Supervisor, decimal Salary) {
        ...
        public virtual int Update(int Id, string Full_Name, string Position, string Department, string Supervisor, decimal Salary, int Original_Id, string Original_Full_Name, string Original_Position, string Original_Department, string Original_Supervisor, decimal Original_Salary) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Full_Name, string Position, string Department, string Supervisor, decimal Salary, int Original_Id, string Original_Full_Name, string Original_Position, string Original_Department, string Original_Supervisor, decimal Original_Salary) {
            return this.Update(Original_Id, Full_Name, Position, Department, Supervisor, Salary, Original_Id, Original_Full_Name, Original_Position, Original_Department, Original_Supervisor, Original_Salary);
        }
    }
